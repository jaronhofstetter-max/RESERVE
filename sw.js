const CACHE='tenderhawk-v121-pwa-1';
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/ranking-v06.js')){
    event.respondWith((async()=>{
      ...
      const loader=`\n;(()=>{\n  document.querySelectorAll('link[href*="dashboard-v08.css"]').forEach(x=>x.remove());\n  const l=document.createElement('link');l.rel='stylesheet';l.href='dashboard-v08.css?v=121';document.head.appendChild(l);\n  document.querySelectorAll('script[src*="dashboard-v08.js"],script[src*="smart-matching-v11.js"],script[src*="brand-header-v112.js"]').forEach(x=>x.remove());\n  const b=document.createElement('script');b.src='brand-header-v112.js?v=121';b.async=false;document.body.appendChild(b);\n  const d=document.createElement('script');d.src='dashboard-v08.js?v=121';d.async=false;document.body.appendChild(d);\n  const s=document.createElement('script');s.src='smart-matching-v11.js?v=121';s.async=false;s.onload=()=>{try{if(typeof live==='function'&&cache.length)live();if(typeof renderTenderDashboard==='function')renderTenderDashboard()}catch(e){}};document.body.appendChild(s);\n})();\n`;
