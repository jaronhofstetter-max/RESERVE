const CACHE='tenderhawk-v140-auth-1';
const APP_SHELL=['/RESERVE/','/RESERVE/index.html','/RESERVE/ranking-v06.js','/RESERVE/dashboard-v08.js','/RESERVE/dashboard-v08.css','/RESERVE/smart-matching-v11.js','/RESERVE/brand-header-v112.js','/RESERVE/push-config.js','/RESERVE/push-client-v13.js','/RESERVE/auth-profile-v14.js','/RESERVE/manifest.webmanifest','/RESERVE/file_0000000013b481f497e7cdb7337b891a.png'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/ranking-v06.js')){
    event.respondWith((async()=>{
      ...
      const loader=`\n;(()=>{\n  document.querySelectorAll('link[href*="dashboard-v08.css"]').forEach(x=>x.remove());\n  const l=document.createElement('link');l.rel='stylesheet';l.href='dashboard-v08.css?v=140';document.head.appendChild(l);\n  document.querySelectorAll('script[src*="dashboard-v08.js"],script[src*="smart-matching-v11.js"],script[src*="brand-header-v112.js"],script[src*="push-config.js"],script[src*="push-client-v13.js"],script[src*="auth-profile-v14.js"]').forEach(x=>x.remove());\n  const b=document.createElement('script');b.src='brand-header-v112.js?v=140';b.async=false;document.body.appendChild(b);\n  const d=document.createElement('script');d.src='dashboard-v08.js?v=140';d.async=false;document.body.appendChild(d);\n  const pc=document.createElement('script');pc.src='push-config.js?v=140';pc.async=false;document.body.appendChild(pc);\n  const p=document.createElement('script');p.src='push-client-v13.js?v=140';p.async=false;document.body.appendChild(p);\n  const a=document.createElement('script');a.src='auth-profile-v14.js?v=140';a.async=false;document.body.appendChild(a);\n  const s=document.createElement('script');s.src='smart-matching-v11.js?v=140';s.async=false;s.onload=()=>{try{if(typeof live==='function'&&cache.length)live();if(typeof renderTenderDashboard==='function')renderTenderDashboard()}catch(e){}};document.body.appendChild(s);\n})();\n`;
