...
(function(){
  ...
  function renderDashboard(){
    ...
    const profileName=(company&&company.value)||'Ihr Unternehmen'; const newCount=activeCache.filter(x=>x.isNew).length; const expiredCount=cache.length-activeCache.length;
    root.innerHTML=`
      ...
      <div class="th-kpis">
        <div class="th-kpi"><div class="th-kpi-label">Aktive Ausschreibungen</div><div class="th-kpi-value">${activeCache.length}</div><div class="th-kpi-note">${newCount} neu seit Refresh</div></div>
